...
export type CpqConfigureType = {
  loginSuccess: Scalars['Boolean']['output'];
...
export type Query = {
  ...
  cpqConfigure?: Maybe<CpqConfigureType>;
...
export type QueryCpqConfigureArgs = {
...
export type GetCpqcOnfigQueryVariables = Exact<{
  productLine: Scalars['String']['input'];
}>;


export type GetCpqcOnfigQuery = { cpqConfigure?: { loginSuccess: boolean, url?: string } };
...
export type GetCategoriesQuery = { categories?: { items?: Array<{ path?: string, name: string, properties: Array<{ name: string, value?: any }> }> } };
...
export type GetBalanceQuery = { mybalance?: { balance: number } };
